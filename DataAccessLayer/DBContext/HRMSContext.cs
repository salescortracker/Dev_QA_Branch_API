...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=192.168.29.53,50491;Database=HRMS_DEV_New;user id= sa; password=CtDev@2026@01; TrustServerCertificate=True;MultipleActiveResultSets=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AttendanceConfigurationId).HasName("PK__Attendan__6E2C34881460F440");
        ...
        {
            entity.HasKey(e => e.AttendanceId).HasName("PK__Attendan__8B69261CCFD33D0D");
            ...
            entity.HasOne(d => d.Building).WithMany(p => p.AttendanceLogs)
                ...
                .HasConstraintName("FK__Attendanc__Build__34B3CB38");
        });
        ...
        {
            entity.HasKey(e => e.BuildingId).HasName("PK__Building__5463CDC459004CB2");
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539B9CFEB5D113");
        ...
        {
            entity.HasKey(e => e.ExperienceId).HasName("PK__Candidat__2F4E3449912B3FE3");
        ...
        {
            entity.HasKey(e => e.InterviewId).HasName("PK__Candidat__C97C58520D76F33B");
        ...
        {
            entity.HasKey(e => e.OfferId).HasName("PK__Candidat__8EBCF0919CF87659");
        ...
        {
            entity.HasKey(e => e.QualificationId).HasName("PK__Candidat__C95C12AA95D49D77");
        ...
        {
            entity.HasKey(e => e.ScreeningId).HasName("PK__Candidat__7734E40C7F6CDF93");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2BB9F15143");
        ...
        {
            entity.HasKey(e => e.NewsId).HasName("PK__CompanyN__954EBDF34206E722");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__CompanyP__2E1339A4BF08EBA8");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__CountryM__10D160BF079B15ED");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__Employee__7AD04F11C7E022F5");
        ...
        {
            entity.HasKey(e => e.WorkingHourDetailId).HasName("PK__Employee__88759D09661E8EA8");
        ...
        {
            entity.HasKey(e => e.WorkingHourHeaderId).HasName("PK__Employee__069BEB0A0D0160BF");
        ...
        {
            entity.HasKey(e => e.StageId).HasName("PK__StageMas__03EB7AD8035BCBE2");
        ...
        {
            entity.HasKey(e => e.TaxId).HasName("PK__TaxSetti__711BE0ACB15FEA27");
        ...
        {
            entity.HasKey(e => e.TaxTypeId).HasName("PK__TaxType__B5343F432598FD6B");
