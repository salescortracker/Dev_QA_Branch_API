...
namespace HRMS_Backend.Controllers
{
    ...
    public class AttendanceController : ControllerBase
    {
        ...
        public AttendanceController(IShiftAllocationService shiftAllocationService, IClockInOutService clockInOutService, ITimesheetService timesheetService, IMissedPunchService service)
        {
